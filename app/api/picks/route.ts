...
export async function PUT(request:Request){
 ...
 if(!body.episodeId||!body.favoriteId||!body.immunityPick||!body.bootPick)return Response.json({error:"Choose your Weekly Favorite, Immunity, and Vote-Out Picks"},{status:400});
 ...
 if((shotInTheDark==="boot"&&!body.bootPick)||(shotInTheDark==="bonus"&&!body.bonusPick))return Response.json({error:"Choose that prediction before playing your Shot in the Dark"},{status:400});
