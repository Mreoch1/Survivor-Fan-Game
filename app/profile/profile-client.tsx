...
export function ProfileClient() {
  ...
  return <form className="profile-card" onSubmit={save}>
    ...
    <div className="profile-fields">
      ...
      <label htmlFor="profile-team">Team name <small>(optional · must be unique)</small></label><input id="profile-team" maxLength={50} value={teamName} onChange={(event) => { setTeamName(event.target.value); setSaved(""); }} placeholder="The Torch Snuffers" />
