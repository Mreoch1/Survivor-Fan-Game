  ...
  return <>
    <header className="site-header">
      <div className="wrap nav-wrap">
        ...
        <nav aria-label="Main navigation"><a href="/play">Play</a><a href="/cast">Cast</a><a href="/campfire">Campfire</a><a href="/messages">Messages{unreadMessages > 0 && <span className="nav-unread" aria-label={`${unreadMessages} unread private messages`}>{unreadMessages > 99 ? "99+" : unreadMessages}</span>}</a><a href="/rules">Rules</a></nav>
